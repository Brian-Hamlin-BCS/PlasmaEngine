######################################
### PlasmaCIAddToTargetsList(<target> [C++])
######################################

function(PlasmaCIAddToTargetsList TARGET_NAME LANGUAGE)
...
######################################
### PlasmaCIAddTest(<target> [NEEDS_HW_ACCESS])
######################################

function(PlasmaCIAddTest TARGET_NAME)
	...
	if (ARG_UNPARSED_ARGUMENTS)
		message(FATAL_ERROR "PlasmaCIAddTest: Invalid arguments '${ARG_UNPARSED_ARGUMENTS}'")
	endif()
